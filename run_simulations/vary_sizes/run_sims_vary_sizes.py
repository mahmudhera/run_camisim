...
metagenome. We will run 50 simulations for each size of the
metagenome. We will vary the size as follows: 0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4, 12.8, 25.6, 51.2, 102.4.
"""
...
def main():
    shell_script_name = "sun_sims_varying_sizes.sh"
    ...
    shell_script.write("run_sims_vary_sizes.py\n\n")
