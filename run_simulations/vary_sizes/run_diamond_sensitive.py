...
def main():
    ...
    for size in [0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4, 12.8, 25.6, 51.2]:
        for i in range(50):
            ...
            diamond_output = "diamond_sensitive_output/diamond_output_" + str(size) + "_seed_" + str(seed)
            gene_output = "diamond_sensitive_output/diamond_gene_results_" + str(size) + "_seed_" + str(seed)
            ko_output = "diamond_sensitive_output/diamond_ko_results_" + str(size) + "_seed_" + str(seed)
            resource_output = "diamond_sensitive_output/diamond_resource_usage_" + str(size) + "_seed_" + str(seed)
